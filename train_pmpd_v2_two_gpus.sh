...
LOG_DIR="$REPO_DIR/training_logs/pmpd_v2_vitb_regularized_margin12_full_cv"
OUTPUT_DIR="outputs/pmpd_v2_vitb_regularized_margin12_full_cv"
RUN_NAME="anymc3d-dinov3-vitb-pmpd-v2-regularized-margin12-full"
...
"$PYTHON" -c \
    'from pathlib import Path; from train_cv import aggregate; aggregate([1, 2, 3, 4, 5], Path("outputs/pmpd_v2_vitb_regularized_margin12_full_cv"))'
echo "$(date -Is) PMPD-v2 regularized margin-12 five-fold training and OOF aggregation completed"
